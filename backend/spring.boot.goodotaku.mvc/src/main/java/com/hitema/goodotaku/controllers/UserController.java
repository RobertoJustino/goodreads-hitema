...
import com.hitema.goodotaku.services.UserService;
...
public class UserController {
    ...
    public ModelAndView userList(ModelMap model, @Param("keyword") String keyword){
        log.trace("User List called");
        model.addAttribute("users", service.listAll(keyword));
